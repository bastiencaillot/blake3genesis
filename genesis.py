...
def get_args():
  ...
  parser.add_option("-z", "--timestamp", dest="timestamp", default="CNBC Aug 20 2021 Nvidia’s USD 40 billion Arm takeover warrants an in-depth competition probe, UK regulator says",
